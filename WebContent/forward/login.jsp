...
.f_reg_but{margin:10px 166px}

.reg{width:460px; font-size:14px;line-height:25px; overflow:hidden;}
.reg dl{padding-left:50px; font-size:14px;}
...
<%
 ...
 <%}else if("isNull".equals(result)){%>
 		alert("账号或密码为空!");         
 <%}else if("isRgst".equals(result)){%>
 		alert("用户已被注销，请联系管理员lys!");
 <%}%>
 </script>
</head>
...
<!--登录开始-->
    <div class="reg login">
        ...
        <form action="${prc }/customerServlet?method=customerLogin" method="post" name="form1" id="form1">
            <dl>
